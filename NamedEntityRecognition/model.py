...
class NERModel(nn.Module):
    def __init__(self, hidden_size=Config.hidden_size, num_class=Config.num_entities):
    ...
    def forward(self, input_tokens : torch.Tensor, input_mask : torch.Tensor, segments_id : torch.Tensor):
        hidden_states = self.bert(input_tokens, attention_mask=input_mask, token_type_ids=segments_id)[0]
